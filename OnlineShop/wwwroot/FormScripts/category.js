                        ...
                        <div class="product-thumb">
                            ...
                            <div>
                                <div class="caption">
                                    ...
                                    <p class="price"> <span class="price-new">${item.priceAfterOffer} تومان</span> <span class="price-old">${item.price} تومان</span> <span class="saving">-${item.offerValue}%</span> <span class="price-tax">بدون مالیات : ${item.priceAfterOffer} تومان</span> </p>
                                </div>
